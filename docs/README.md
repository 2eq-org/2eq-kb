...
This section archives the **primary source materials** associated with the 2EQ framework and the Singular Motivational Subversion Hypothesis (SMSH).

These documents provide background, context, and original exposition.  
They are included for **transparency and reference**, not as proof of any claim.

Where possible, key concepts are summarized in HTML elsewhere in this knowledge base to improve accessibility and evaluability.
...
- Status: Source document
- Notes: Conceptual foundation; not empirical validation.

### The Containments
- Description: Analysis of psychological containment patterns (an updated excerpt from Organic Psychology).
- Status: Source document
...
- Description: A later full length reworking of the broader 2EQ framework, particularly addressing the 'release event' in more detail.
- Status: Source document
- Notes: Contextual and philosophical.
...
- Description: The full (now removed) 'section one' from the original draft of Organic Psychology.
- Status: Source document
...
Additional materials that inform or contextualize the framework:

- Shallow / Deep snapshots
- Summaries and comparative analyses
- Historical or interpretive essays
  
- Further materials (including audio versions of all documents listed above) can be requested here - 2eq.org@gmail.com 

These materials should be treated as **secondary**.

---

## Document handling principles
- Inclusion here does **not** imply endorsement.
- Documents may contain speculative or interpretive content.
- Readers should distinguish original exposition from evaluated claims.

---

## Versioning and provenance
All documents are preserved as uploaded.  
Revisions or replacements will be logged explicitly.
